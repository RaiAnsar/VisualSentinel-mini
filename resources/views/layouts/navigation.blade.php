            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-x-3">
                        <img src="{{ Vite::asset('public/images/logo.svg') }}" alt="Visual Sentinel" class="h-16 w-16">
                        <span class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#7B42F6] to-[#4A6FFB]">Visual Sentinel</span>
                    </a>
                </div>
